            ...
            <div className="container relative h-auto md:h-[18rem]">
                <div className=" w-full h-[18rem] md:h-full flex flex-col justify-center md:w-11/12 bg-white rounded-t-md md:rounded-md px-8 py-14 ">
                    <div className=" w-full md:w-1/2 flex flex-col gap-3">
                        ...
                        <h2 className=" font-semibold md:text-4xl text-slate-900">
                            What we do
                        </h2>
                        <p className="">
                            we specialize in providing the materials for essential
                            infrastructure, enabling better standards of living and
                            facilitating greater prosperity.
                        </p>
                    </div>
                </div>
